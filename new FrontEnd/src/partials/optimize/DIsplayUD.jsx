...
function DisplaySelected({ items, onRemoveItem }) {
    ...
    useEffect(() => {
        if (
            ...
            setActiveColor(
                'linear-gradient(90deg, rgba(0,183,255,1) 0%, rgba(104,94,255,1) 100%)'
            );
        } else {
            setActiveColor(
                'linear-gradient(90deg, rgba(30,41,59,1) 0%, rgba(0,183,255,1) 100%)'
            );
        }
    }, []);
                            ...
                            {onRemoveItem !== undefined && (
                                <div>
                                    <IconButton
                                        ...
                                        edge="end"
                                        style={{ color: 'white' }}
                                        onClick={() => {handleRemoveItem(index), setIndex(index)}}
                                    >
                    ...
                    <div className="bg-white rounded-lg p-6 flex flex-col">
                        <div className="flex justify-end">
                            <IconButton
                                size="small"
                                style={{ color: 'black' }}
                                onClick={() => {setShowPopup(false), setRating(5)}}
                            >
                                <CloseIcon />
                            </IconButton>
                        </div>
