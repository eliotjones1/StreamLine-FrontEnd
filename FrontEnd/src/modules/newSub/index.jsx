...
import { AccountActions } from '/src/modules/common/components/Header/components';
...
export default function WelcomePage(){
  ...
  const handleSubmit = () => {
    ...
    if (!tos) {
      ...
      axios
        .post('http://127.0.0.1:8000/api/user/subscriptions/generateBundle/', [session.email], {
          withCredentials: true,
        })
        .then(() => {
          ...
          <section>
            <div className="max-w-3xl mx-auto text-center relative pb-6 md:pt-28 md:pb-8">
              <h1 className="h1 mb-4" data-aos="fade-up">
                <span className="text-sky-600">Welcome, </span>
                {session.first_name}
              </h1>
              ...
              <p className="text-xl text-gray-600" data-aos="fade-up">
                <span className="text-white">
                  Before you get started on your StreamLine journey, we need some information from
                  you to help us better achieve your goals. Please input the required information on
                  each of the following pages before you access the rest of the site. Thank you!
                </span>
              </p>
            </div>
          </section>
