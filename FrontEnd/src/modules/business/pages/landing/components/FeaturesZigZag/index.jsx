...
import FeatImage01 from 'src/assets/images/Search_Light_Mode.png';
import FeatImage02 from 'src/assets/images/Dash_Light_Mode.png';
						...
						<div className="lg:pr-4">
							<div className="lg:w-full">
								...
								<p className="mt-6 text-xl leading-8 text-gray-700 dark:text-gray-300">
									Experience personalized streaming like never before! Our
									platform delivers custom recommendations to match your unique
									tastes. Immerse yourself in captivating content curated just
									for you. Unlock a universe of entertainment made personal.
								</p>
							</div>
						</div>
					</div>
					...
					<div className="lg:col-span-2 lg:col-start-1 lg:row-start-2 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
						<div className="lg:pr-4">
							<div className="max-w-xl text-base leading-7 lg:max-w-lg">
								<ul
									role="list"
									className="space-y-6 text-slate-600 dark:text-gray-400"
								>
									<li className="flex gap-x-3">
										...
										<span>
											...
											StreamLine your search and discover shows and movies
											across streaming services. Elevate your viewing experience
											effortlessly.
										</span>
									</li>
									<li className="flex gap-x-3">
										...
										<span>
											...
											Simply provide us with your desired viewing content to
											curate a personalized bundle of the best streaming
											services. Stream smarter, save more, no work required.
										</span>
									</li>
								</ul>
							</div>
					...
					<div className="lg:col-span-2 lg:col-start-1 lg:row-start-5 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
						<div className="lg:col-start-2 lg:pl-4 ">
							<div className="lg:w-full">
								...
								<p className="mt-6 text-xl leading-8 text-gray-700 dark:text-gray-300">
									Discover the power of subscription optimization and start
									saving today. Our intuitive platform simplifies subscription
									management, providing valuable insights and tailored
									recommendations. Take charge of your finances effortlessly and
								...
								>
									<li className="flex gap-x-3">
										...
										<span>
											...
											Take control of your subscriptions in one place. Never
											miss a chance to save with easy management of renewals,
									...
									<li className="flex gap-x-3">
										...
										<span>
											...
											Unlock significant savings with personalized
											recommendations based on your usage patterns. Say goodbye
											to unused services and hello to optimized subscriptions.
										</span>
									</li>
								</ul>
							</div>
