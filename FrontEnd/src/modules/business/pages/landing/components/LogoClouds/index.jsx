					...
					<div className="flex flex-wrap items-center gap-x-4 gap-y-2">
						<p className="text-sm leading-6">
							<strong className="font-semibold">
								Streaming Optimization Perfected:{' '}
							</strong>
							Harness the Power of{' '}
							<strong className="font-semibold">150+</strong> Platforms and
							More!
						</p>
						<p className="font-semibold text-sky-600 hover:text-sky-700 dark:hover:text-sky-500">
