...
export default function Content() {
  const { content, lastSearch, returnToMain, getGenreById } = useSearch();
  ...
  return (
    <section className="max-w-6xl mx-auto">
      <div className="flex justify-between pb-10">
        <p className="mr-auto">Showing search results for &quot;{lastSearch}&quot;</p>
                ...
                <div className="w-full relative flex-auto">
                  ...
                  <div className="mt-2 flex-rows flex-wrap text-sm leading-6 font-medium">
                    <div className="absolute top-0 right-0 flex items-center space-x-1">
                      ...
                      {content.vote_average && <div>{content.vote_average.toFixed(1)} / 10</div>}
                    </div>
                    ...
                    {content.release_date && (
                      <div className="flex space-x-1 mb-2">
                        ...
                        <p>
                          {new Date(content.release_date).toLocaleString('en-US', {
                            year: 'numeric',
                          })}
                        </p>
                      </div>
                    ...
                    {content.first_air_date && (
                      <div className="flex space-x-1 mb-2">
                        <p className="font-semibold">Release Year:</p>
                        <p>
                          {new Date(content.first_air_date).toLocaleString('en-US', {
                            year: 'numeric',
                          })}
                        </p>
                      </div>
