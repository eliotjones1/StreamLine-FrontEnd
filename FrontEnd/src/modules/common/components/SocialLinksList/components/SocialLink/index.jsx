...
export default function SocialLink({ link }) {
  ...
  return (
    <Link
      to={link}
      target="_blank"
      className="flex justify-center items-center text-slate-800 bg-slate-100 dark:text-sky-600 dark:bg-slate-800 hover:text-gray-100 hover:bg-sky-600 rounded-full transition duration-150 ease-in-out"
      aria-label={platform}
    >
