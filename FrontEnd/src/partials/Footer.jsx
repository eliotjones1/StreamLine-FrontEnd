        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-12 gap-8 lg:gap-20 mb-8 md:mb-12">
            ...
            <div className="md:col-span-4 lg:col-span-5">
              ...
              <div className="text-slate-600 dark:text-gray-400">Stanford University 450 Serra Mall, Stanford, CA 94305</div>
              <div className="text-slate-600 dark:text-gray-400">(704) 773-9313</div>
              <div className="text-slate-600 dark:text-gray-400">rcdunn01@stanford.edu</div>
            </div>
            ...
            <div className="md:col-span-8 lg:col-span-7 grid sm:grid-cols-3 gap-8">
              ...
              <div className="text-sm">
                <h6 className="text-slate-800 dark:text-gray-200 font-medium mb-1">Products</h6>
                <ul>
                  <li className="mb-1">
                    <button onClick={() => nav('/search')} className="text-slate-600 dark:text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out">Subscription Optimization</button>
                  </li>
                </ul>
              </div>
              ...
              {/* 3rd block */}
              <div className="text-sm">
                <h6 className="text-slate-800 dark:text-gray-200 font-medium mb-1">Resources</h6>
                <ul>
                  <li className="mb-1">
                    <Link to="#0" className="text-slate-600 dark:text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out"></Link>
                  </li>
                </ul>
              </div>
              ...
              {/* 4th block */}
              <div className="text-sm">
                <h6 className="text-slate-800 dark:text-gray-200 font-medium mb-1">Company</h6>
                <ul>
                  <li className="mb-1">
                    <Link to="#0" className="text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out"></Link>
                  </li>
                </ul>
              </div>
          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            {/* Copyrights note */}
            <div className="text-slate-600 dark:text-gray-400 text-sm mr-4">&copy; StreamLine.com. All rights reserved.</div>
            <div className="text-slate-600 dark:text-gray-400 text-sm mr-4">This product uses the TMDB API but is not endorsed or certified by TMDB.</div>
          </div>
