    ...
    <section>
      <div className="max-w-4xl mx-auto">
        <div className="flex relative mx-auto w-full pb-10 align-center">
          ...
          <div className="container relative pb-10">
            {session !== undefined ? (
              <input
                ...
                value={budget}
                onChange={(event) => {
                  onSetBudget(event.target.value);
                }}
                step="0.01"
                min="0"
                className="absolute rounded-md pl-6 pr-1 text-right bg-slate-100 dark:bg-white text-gray-900 placeholder-gray-500"
              />
            ) : (
              <input
                id="budget"
                ...
                step="0.01"
                min="0"
                className="absolute rounded-md pl-6 pr-1 text-right text-gray-900 bg-slate-100 dark:bg-white placeholder-gray-500"
              />
            )}
          ...
          <button
            className="text-2xl font-bold h-full cursor-pointer text-sky-500"
