...
export default function Story(){
  return (
    <section className='space-y-4 my-20'>
        ...
        <p className='text-lg leading-8'>
          As <span className='text-sky-600 font-semibold'>StreamLine</span> took shape, we saw an opportunity to empower entertainment enthusiasts worldwide by eliminating unnecessary complexities. Our platform became a place where users could easily discover and enjoy premium content, allowing them to focus solely on their entertainment journey.
        </p>
        {quote()}
        <p className='text-lg leading-8'>
          Today, <span className='text-sky-600 font-semibold'>StreamLine</span> stands as a trailblazer in the world of entertainment access, reshaping how content is consumed and enjoyed. Our journey is far from over, and our vision is as strong as ever. We aspire to be the go-to platform for millions of users, delivering an optimized and personalized entertainment experience that exceeds expectations.
        </p>
    </section>
  );
}
...
function quote() {
  return (
    <section className="relative isolate overflow-hidden bg-white p-6">
      <div className="absolute inset-0 -z-10 bg-[radial-gradient(45rem_50rem_at_top,theme(colors.sky.100),white)] opacity-20" />
      <div className="absolute inset-y-0 right-1/2 -z-10 mr-16 w-[200%] origin-bottom-left skew-x-[-30deg] bg-white dark:bg-slate-900 shadow-xl shadow-sky-600/10 ring-1 ring-sky-50 sm:mr-28 lg:mr-0 xl:mr-16 xl:origin-center" />
      <div className="mx-auto max-w-2xl lg:max-w-4xl">
        <figure className="mt-10">
          <blockquote className="text-center text-sky-600 text-xl font-semibold leading-8 text-gray-900 sm:text-2xl sm:leading-9">
            <p>
              “Our journey with StreamLine has been about simplifying the complicated and bringing joy back to content discovery. We're thrilled to share this innovative platform with the world.”
            </p>
          </blockquote>
