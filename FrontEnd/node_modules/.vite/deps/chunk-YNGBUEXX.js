import {
  ...
  removeClass
} from "./chunk-6ICCWTRZ.js";
import {
  _inheritsLoose
} from "./chunk-QHWSBPK4.js";
import {
...
var _excluded9 = ["absolute", "children", "className", "component", "flexItem", "light", "orientation", "role", "textAlign", "variant"];
...
var Divider = React12.forwardRef(function Divider2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiDivider"
  });
  ...
  return (0, import_jsx_runtime8.jsx)(DividerRoot, _extends({
    ...
    children: children2 ? (0, import_jsx_runtime8.jsx)(DividerWrapper, {
...
var ListItemIcon = React14.forwardRef(function ListItemIcon2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiListItemIcon"
  });
...
var _excluded11 = ["children", "className", "disableTypography", "inset", "primary", "primaryTypographyProps", "secondary", "secondaryTypographyProps"];
...
var ListItemText = React15.forwardRef(function ListItemText2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiListItemText"
  });
  ...
  const {
    dense
  } = React15.useContext(ListContext_default);
...
var _excluded12 = ["autoFocus", "component", "dense", "divider", "disableGutters", "focusVisibleClassName", "role", "tabIndex", "className"];
...
var MenuItem = React16.forwardRef(function MenuItem2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiMenuItem"
  });
  ...
  const context = React16.useContext(ListContext_default);
  const childContext = React16.useMemo(() => ({
    dense: dense || context.dense || false,
    disableGutters
  }), [context.dense, dense, disableGutters]);
  const menuItemRef = React16.useRef(null);
  useEnhancedEffect_default2(() => {
    if (autoFocus) {
...
var List = React17.forwardRef(function List2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiList"
  });
...
var MenuList = React18.forwardRef(function MenuList2(props, ref) {
  const {
    // private
  ...
  React18.useImperativeHandle(actions, () => ({
  ...
  React18.Children.forEach(children2, (child, index) => {
  ...
  const items = React18.Children.map(children2, (child, index) => {
    if (index === activeItemIndex) {
      ...
      return React18.cloneElement(child, newChildProps);
    }
    return child;
  });
...
function ClickAwayListener(props) {
  ...
  return (0, import_jsx_runtime16.jsx)(React19.Fragment, {
    children: React19.cloneElement(children2, childrenProps)
  });
}
...
function FocusTrap(props) {
  ...
  return (0, import_jsx_runtime18.jsxs)(React20.Fragment, {
    ...
    }), React20.cloneElement(children2, {
      ref: handleRef,
      onFocus
...
var Portal = React21.forwardRef(function Portal2(props, forwardedRef) {
  const {
    children: children2,
    container,
    disablePortal = false
  ...
  const handleRef = useForkRef(React21.isValidElement(children2) ? children2.ref : null, forwardedRef);
  useEnhancedEffect_default(() => {
    if (!disablePortal) {
  ...
  if (disablePortal) {
    if (React21.isValidElement(children2)) {
      ...
      return React21.cloneElement(children2, newProps);
    }
...
true ? NoSsr.propTypes = {
   ...
   * @default false
   */
  defer: import_prop_types20.default.bool,
  /**
   * The fallback content to display.
   * @default null
   */
  fallback: import_prop_types20.default.node
} : void 0;
if (true) {
...
var TextareaAutosize = React23.forwardRef(function TextareaAutosize2(props, forwardedRef) {
  ...
  const getUpdatedState = React23.useCallback(() => {
  ...
  return (0, import_jsx_runtime22.jsxs)(React23.Fragment, {
    children: [(0, import_jsx_runtime21.jsx)("textarea", _extends({
      value,
    ...
    }, other)), (0, import_jsx_runtime21.jsx)("textarea", {
      "aria-hidden": true,
...
function useAutocomplete(props) {
  ...
  const ignoreFocus = React24.useRef(false);
  const firstFocus = React24.useRef(true);
  const inputRef = React24.useRef(null);
  const listboxRef = React24.useRef(null);
  const [anchorEl, setAnchorEl] = React24.useState(null);
  const [focusedTag, setFocusedTag] = React24.useState(-1);
  const defaultHighlighted = autoHighlight ? 0 : -1;
  const highlightedIndexRef = React24.useRef(defaultHighlighted);
  ...
  const resetInputValue = React24.useCallback((event, newValue) => {
  ...
  const [inputPristine, setInputPristine] = React24.useState(true);
  ...
  const syncHighlightedIndex = React24.useCallback(() => {
    if (!popupOpen) {
      return;
    }
  ...
  const isTouch = React24.useRef(false);
...
var FormControlContext = React25.createContext(void 0);
if (true) {
...
function GlobalStyles(props) {
  return (0, import_jsx_runtime23.jsx)(GlobalStyles_default, _extends({}, props, {
...
function useSlotProps(parameters) {
  ...
  } = parameters, rest = _objectWithoutPropertiesLoose(parameters, _excluded16);
...
var _excluded17 = ["badgeContent", "children", "invisible", "max", "slotProps", "slots", "showZero"];
...
var Badge = React29.forwardRef(function Badge2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime26.jsxs)(Root, _extends({}, rootProps, {
    children: [children2, (0, import_jsx_runtime25.jsx)(BadgeComponent, _extends({}, badgeProps, {
...
function useButton(parameters = {}) {
  ...
  const [hostElementName, setHostElementName] = React30.useState("");
  ...
  const updateHostElementName = React30.useCallback((instance) => {
...
var _excluded18 = ["action", "children", "disabled", "focusableWhenDisabled", "onFocusVisible", "slotProps", "slots"];
...
true ? Button.propTypes = {
   ...
   * @default false
   */
  focusableWhenDisabled: import_prop_types24.default.bool,
  /**
   * @ignore
   */
   ...
   * @ignore
   */
  to: import_prop_types24.default.string
} : void 0;
...
function Dropdown(props) {
  ...
  return (0, import_jsx_runtime28.jsx)(DropdownContext.Provider, {
    value: contextValue,
    children: children2
  });
}
true ? Dropdown.propTypes = {
   ...
   */
  onOpenChange: import_prop_types25.default.func,
  /**
...
var _excluded19 = ["defaultValue", "children", "disabled", "error", "onChange", "required", "slotProps", "slots", "value"];
...
var FormControl = React37.forwardRef(function FormControl2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime29.jsx)(FormControlContext2.Provider, {
    value: childContext,
...
var _excluded20 = ["aria-describedby", "aria-label", "aria-labelledby", "autoComplete", "autoFocus", "className", "defaultValue", "disabled", "endAdornment", "error", "id", "multiline", "name", "onClick", "onChange", "onKeyDown", "onKeyUp", "onFocus", "onBlur", "placeholder", "readOnly", "required", "startAdornment", "value", "type", "rows", "slotProps", "slots", "minRows", "maxRows"];
...
var Input = React40.forwardRef(function Input2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime31.jsxs)(Root, _extends({}, rootProps, {
    children: [startAdornment, (0, import_jsx_runtime30.jsx)(InputComponent, _extends({}, inputProps)), endAdornment]
  }));
});
true ? Input.propTypes = {
   ...
   */
  maxRows: import_prop_types27.default.number,
  /**
   * Minimum number of rows to display when multiline option is set to true.
   */
  minRows: import_prop_types27.default.number,
  /**
   ...
   */
  rows: import_prop_types27.default.number,
  /**
  ...
  slots: import_prop_types27.default.shape({
    ...
    textarea: import_prop_types27.default.elementType
  }),
  /**
   ...
   * @default 'text'
   */
  type: import_prop_types27.default.oneOf(["button", "checkbox", "color", "date", "datetime-local", "email", "file", "hidden", "image", "month", "number", "password", "radio", "range", "reset", "search", "submit", "tel", "text", "time", "url", "week"]),
  /**
...
function useListChangeNotifiers() {
  ...
  const notifySelectionChanged = React42.useCallback((newSelectedItems) => {
    messageBus.publish(SELECTION_CHANGE_TOPIC, newSelectedItems);
  }, [messageBus]);
  const notifyHighlightChanged = React42.useCallback((newHighlightedItem) => {
    messageBus.publish(HIGHLIGHT_CHANGE_TOPIC, newHighlightedItem);
  }, [messageBus]);
  const registerSelectionChangeHandler = React42.useCallback((handler) => {
    return messageBus.subscribe(SELECTION_CHANGE_TOPIC, handler);
  }, [messageBus]);
  const registerHighlightChangeHandler = React42.useCallback((handler) => {
...
function useTextNavigation(callback) {
  const textCriteriaRef = React44.useRef({
    searchString: "",
    lastTime: null
  });
...
function useList(params) {
  ...
  const handleHighlightChange = React45.useCallback((event, value, reason) => {
  ...
  const stateComparers = React45.useMemo(() => ({
    highlightedValue: itemComparer,
    selectedValues: (valuesArray1, valuesArray2) => areArraysEqual(valuesArray1, valuesArray2, itemComparer)
  }), [itemComparer]);
  const handleStateChange = React45.useCallback((event, field, value, reason, state2) => {
  ...
  const listActionContext = React45.useMemo(() => {
    return {
      disabledItemsFocusable,
      disableListWrap,
      focusManagement,
  ...
  const actionContext = React45.useMemo(() => _extends({}, reducerActionContext, listActionContext), [reducerActionContext, listActionContext]);
  const [state, dispatch] = useControllableReducer({
    reducer,
    actionContext,
    initialState,
  ...
  const previousItems = React45.useRef([]);
  React45.useEffect(() => {
  ...
  const getItemState = React45.useCallback((item) => {
...
function useForcedRerendering() {
  const [, setState] = React46.useState({});
  return React46.useCallback(() => {
    setState({});
  }, []);
}
...
var ListContext2 = React47.createContext(null);
if (true) {
...
function useListItem(parameters) {
  ...
  const listContext = React48.useContext(ListContext2);
  if (!listContext) {
  ...
  const createHandleClick = React48.useCallback((other) => (event) => {
    var _other$onClick;
  ...
  const createHandlePointerOver = React48.useCallback((other) => (event) => {
...
var CompoundComponentContext = React49.createContext(null);
...
function useCompoundParent() {
  const [subitems, setSubitems] = React49.useState(/* @__PURE__ */ new Map());
  const subitemKeys = React49.useRef(/* @__PURE__ */ new Set());
  const deregisterItem = React49.useCallback(function deregisterItem2(id) {
  ...
  const registerItem = React49.useCallback(function registerItem2(id, item) {
  ...
  const sortedSubitems = React49.useMemo(() => sortSubitems(subitems), [subitems]);
  const getItemIndex = React49.useCallback(function getItemIndex2(id) {
...
function useMenu(parameters = {}) {
  ...
  const {
    ...
    triggerElement,
    registerPopup
  } = (_React$useContext = React50.useContext(DropdownContext)) != null ? _React$useContext : FALLBACK_MENU_CONTEXT;
  const isInitiallyOpen = React50.useRef(open);
  const {
    subitems,
    contextValue: compoundComponentContextValue
  } = useCompoundParent();
  const subitemKeys = React50.useMemo(() => Array.from(subitems.keys()), [subitems]);
...
function MenuProvider(props) {
  ...
  return (0, import_jsx_runtime32.jsx)(CompoundComponentContext.Provider, {
    ...
    children: (0, import_jsx_runtime32.jsx)(ListContext2.Provider, {
...
var PopperTooltip = React52.forwardRef(function PopperTooltip2(props, forwardedRef) {
  var _slots$root;
  const {
    anchorEl,
    children: children2,
...
var Popper = React52.forwardRef(function Popper2(props, forwardedRef) {
  const {
    anchorEl,
    children: children2,
...
var _excluded24 = ["actions", "children", "onItemsChange", "slotProps", "slots"];
...
var Menu = React53.forwardRef(function Menu2(props, forwardedRef) {
  ...
  if (open === true && triggerElement == null) {
    return (0, import_jsx_runtime34.jsx)(Root, _extends({}, rootProps, {
      children: (0, import_jsx_runtime34.jsx)(Listbox, _extends({}, listboxProps, {
        children: (0, import_jsx_runtime34.jsx)(MenuProvider, {
          value: contextValue,
          children: children2
        })
      }))
  ...
  return (0, import_jsx_runtime34.jsx)(Popper, _extends({}, rootProps, {
    open,
...
function useMenuButton(parameters = {}) {
  ...
  const menuContext = React54.useContext(DropdownContext);
  if (menuContext === null) {
...
var _excluded25 = ["children", "disabled", "label", "slots", "slotProps", "focusableWhenDisabled"];
...
var MenuButton = React55.forwardRef(function MenuButton2(props, forwardedRef) {
  const {
    children: children2,
    disabled = false,
    slots = {},
...
var menuItemClasses2 = generateUtilityClasses("MuiMenuItem", ["root", "disabled", "focusVisible"]);
...
function useCompoundItem(id, itemMetadata) {
  const context = React56.useContext(CompoundComponentContext);
  if (context === null) {
  ...
  const [registeredId, setRegisteredId] = React56.useState(typeof id === "function" ? void 0 : id);
  useEnhancedEffect_default(() => {
    const {
      id: returnedId,
      deregister
...
function useMenuItem(params) {
  ...
  const itemMetadata = React57.useMemo(() => ({
    disabled,
    id: id != null ? id : "",
    label,
    ref: itemRef
  ...
  const {
    dispatch
  } = (_React$useContext = React57.useContext(DropdownContext)) != null ? _React$useContext : FALLBACK_MENU_CONTEXT2;
  const {
    getRootProps: getListRootProps,
    highlighted,
...
var _excluded26 = ["children", "disabled", "label", "slotProps", "slots"];
...
var MenuItem3 = React58.forwardRef(function MenuItem4(props, forwardedRef) {
  var _slots$root;
  const {
    children: children2,
    disabled: disabledProp = false,
...
var _excluded27 = ["children", "closeAfterTransition", "container", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted", "manager", "onBackdropClick", "onClose", "onKeyDown", "open", "onTransitionEnter", "onTransitionExited", "slotProps", "slots"];
...
var Modal = React59.forwardRef(function Modal2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime37.jsx)(
    Portal,
    {
      ...
      container,
      disablePortal,
      children: (0, import_jsx_runtime38.jsxs)(Root, _extends({}, rootProps, {
        children: [!hideBackdrop && BackdropComponent ? (0, import_jsx_runtime37.jsx)(BackdropComponent, _extends({}, backdropProps)) : null, (0, import_jsx_runtime37.jsx)(FocusTrap, {
          disableEnforceFocus,
          disableAutoFocus,
          disableRestoreFocus,
          isEnabled: isTopModal,
          open,
          children: React59.cloneElement(children2, childProps)
        })]
      }))
    }
  );
...
function useNumberInput(parameters) {
  ...
  const {
    current: isControlled
  } = React60.useRef(valueProp != null);
  const handleInputRefWarning = React60.useCallback((instance) => {
    if (true) {
      if (instance && instance.nodeName !== "INPUT" && !instance.focus) {
        console.error(["MUI: You have provided a `slots.input` to the input component", "that does not correctly handle the `ref` prop.", "Make sure the `ref` prop is called with a HTMLInputElement."].join("\n"));
      }
  ...
  const [value, setValue] = React60.useState(valueProp != null ? valueProp : defaultValueProp);
  const [dirtyValue, setDirtyValue] = React60.useState(value ? String(value) : void 0);
  React60.useEffect(() => {
...
var _excluded28 = ["className", "defaultValue", "disabled", "error", "id", "max", "min", "onBlur", "onInputChange", "onFocus", "onChange", "placeholder", "required", "readOnly", "shiftMultiplier", "step", "value", "slotProps", "slots"];
...
var NumberInput = React61.forwardRef(function NumberInput2(props, forwardedRef) {
  ...
  const {
    ...
    slotProps = {},
    slots = {}
  } = props, rest = _objectWithoutPropertiesLoose(props, _excluded28);
  const {
    getRootProps,
    getInputProps,
    getIncrementButtonProps,
  ...
  return (0, import_jsx_runtime40.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime39.jsx)(DecrementButton, _extends({}, decrementButtonProps)), (0, import_jsx_runtime39.jsx)(IncrementButton, _extends({}, incrementButtonProps)), (0, import_jsx_runtime39.jsx)(Input5, _extends({}, inputProps))]
  }));
});
true ? NumberInput.propTypes = {
   ...
   * The maximum value.
   */
  max: import_prop_types33.default.number,
  /**
   * The minimum value.
   */
  min: import_prop_types33.default.number,
  /**
   * @ignore
   */
   ...
   */
  onInputChange: import_prop_types33.default.func,
  /**
   * @ignore
   */
   ...
   */
  shiftMultiplier: import_prop_types33.default.number,
  /**
   * The props used for each slot inside the NumberInput.
   * @default {}
   */
  slotProps: import_prop_types33.default.shape({
    decrementButton: import_prop_types33.default.oneOfType([import_prop_types33.default.func, import_prop_types33.default.object]),
    incrementButton: import_prop_types33.default.oneOfType([import_prop_types33.default.func, import_prop_types33.default.object]),
  ...
  slots: import_prop_types33.default.shape({
    decrementButton: import_prop_types33.default.elementType,
    incrementButton: import_prop_types33.default.elementType,
   ...
   */
  step: import_prop_types33.default.number,
  /**
...
var _excluded29 = ["disabled", "slotProps", "slots"];
function useUtilityClasses19(disabled) {
  const slots = {
...
var OptionGroup = React62.forwardRef(function OptionGroup2(props, forwardedRef) {
  const {
    disabled = false,
    slotProps = {},
    slots = {}
  ...
  const classes = useUtilityClasses19(disabled);
  const rootProps = useSlotProps({
    elementType: Root,
    externalSlotProps: slotProps.root,
    externalForwardedProps: other,
  ...
  return (0, import_jsx_runtime42.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime41.jsx)(Label, _extends({}, labelProps, {
      children: props.label
    })), (0, import_jsx_runtime41.jsx)(List3, _extends({}, listProps, {
...
function useOption(params) {
  ...
  const selectOption = React63.useMemo(() => ({
    disabled,
    label,
    value,
    ref: optionRef,
...
var _excluded30 = ["children", "disabled", "label", "slotProps", "slots", "value"];
...
var Option = React64.memo(React64.forwardRef(function Option2(props, forwardedRef) {
  ...
  const Root = (_slots$root = slots.root) != null ? _slots$root : "li";
  const optionRef = React64.useRef(null);
...
var _excluded31 = ["areOptionsEqual", "autoFocus", "children", "defaultValue", "defaultListboxOpen", "disabled", "getSerializedValue", "listboxId", "listboxOpen", "multiple", "name", "onChange", "onListboxOpenChange", "getOptionAsString", "renderValue", "slotProps", "slots", "value"];
function defaultRenderValue(selectedOptions) {
  var _selectedOptions$labe;
  if (Array.isArray(selectedOptions)) {
    return (0, import_jsx_runtime45.jsx)(React67.Fragment, {
...
var Select = React67.forwardRef(function Select2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime46.jsxs)(React67.Fragment, {
    children: [(0, import_jsx_runtime45.jsx)(Button5, _extends({}, buttonProps, {
      children: renderValue(selectedOptionsMetadata)
    })), buttonDefined && (0, import_jsx_runtime45.jsx)(PopperComponent, _extends({}, popperProps, {
      children: (0, import_jsx_runtime45.jsx)(ListboxRoot, _extends({}, listboxProps, {
        children: (0, import_jsx_runtime45.jsx)(SelectProvider, {
          value: contextValue,
          children: children2
        })
      }))
    })), name && (0, import_jsx_runtime45.jsx)("input", {
      type: "hidden",
      name,
...
function useSlider(parameters) {
  ...
  const sliderRef = React68.useRef();
  ...
  const previousIndex = React68.useRef();
...
var _excluded32 = ["aria-label", "aria-valuetext", "aria-labelledby", "className", "disableSwap", "disabled", "getAriaLabel", "getAriaValueText", "marks", "max", "min", "name", "onChange", "onChangeCommitted", "orientation", "scale", "step", "tabIndex", "track", "value", "valueLabelFormat", "isRtl", "defaultValue", "slotProps", "slots"];
...
var Slider = React69.forwardRef(function Slider2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime48.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime47.jsx)(Rail, _extends({}, railProps)), (0, import_jsx_runtime47.jsx)(Track, _extends({}, trackProps)), marks.filter((mark) => mark.value >= min && mark.value <= max).map((mark, index) => {
      ...
      return (0, import_jsx_runtime48.jsxs)(React69.Fragment, {
        children: [(0, import_jsx_runtime47.jsx)(Mark, _extends({
          "data-index": index
        ...
        })), mark.label != null ? (0, import_jsx_runtime47.jsx)(MarkLabel, _extends({
          "aria-hidden": true,
          "data-index": index
      ...
      return (0, import_jsx_runtime48.jsxs)(Thumb, _extends({
        "data-index": index
        ...
        children: [(0, import_jsx_runtime47.jsx)(Input5, _extends({
          "data-index": index,
          ...
          value: values2[index]
        }, inputProps)), ValueLabel ? (0, import_jsx_runtime47.jsx)(ValueLabel, _extends({}, !isHostComponent(ValueLabel) && {
          valueLabelFormat,
          index,
          disabled
        }, valueLabelProps, {
...
function useSnackbar(parameters) {
  ...
  const timerAutoHide = React70.useRef();
  React70.useEffect(() => {
    if (!open) {
      return void 0;
    }
...
var _excluded33 = ["autoHideDuration", "children", "disableWindowBlurListener", "exited", "onBlur", "onClose", "onFocus", "onMouseEnter", "onMouseLeave", "open", "resumeHideDuration", "slotProps", "slots"];
...
var Snackbar = React71.forwardRef(function Snackbar2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime49.jsx)(ClickAwayListener, _extends({}, clickAwayListenerProps, {
...
var _excluded34 = ["checked", "defaultChecked", "disabled", "onBlur", "onChange", "onFocus", "onFocusVisible", "readOnly", "required", "slotProps", "slots"];
...
var Switch = React73.forwardRef(function Switch2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime51.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime50.jsx)(Track, _extends({}, trackProps)), (0, import_jsx_runtime50.jsx)(Thumb, _extends({}, thumbProps)), (0, import_jsx_runtime50.jsx)(Input5, _extends({}, inputProps))]
  }));
});
...
var _excluded35 = ["count", "getItemAriaLabel", "onPageChange", "page", "rowsPerPage", "showFirstButton", "showLastButton", "direction", "ownerState", "slotProps", "slots"];
var _span;
var _span2;
var _span3;
var _span4;
function LastPageIconDefault() {
  return _span || (_span = (0, import_jsx_runtime52.jsx)("span", {
    children: "⇾|"
  }));
}
function FirstPageIconDefault() {
  return _span2 || (_span2 = (0, import_jsx_runtime52.jsx)("span", {
    children: "|⇽"
  }));
}
function NextPageIconDefault() {
  return _span3 || (_span3 = (0, import_jsx_runtime52.jsx)("span", {
    children: "⇾"
  }));
}
function BackPageIconDefault() {
  return _span4 || (_span4 = (0, import_jsx_runtime52.jsx)("span", {
    children: "⇽"
  }));
}
...
var TablePaginationActions = React74.forwardRef(function TablePaginationActions2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime53.jsxs)(Root, _extends({}, rootProps, {
    children: [showFirstButton && (0, import_jsx_runtime52.jsx)(FirstButton, _extends({}, firstButtonProps, {
      children: direction === "rtl" ? (0, import_jsx_runtime52.jsx)(LastPageIcon, {}) : (0, import_jsx_runtime52.jsx)(FirstPageIcon, {})
    })), (0, import_jsx_runtime52.jsx)(BackButton, _extends({}, backButtonProps, {
      children: direction === "rtl" ? (0, import_jsx_runtime52.jsx)(NextPageIcon, {}) : (0, import_jsx_runtime52.jsx)(BackPageIcon, {})
    })), (0, import_jsx_runtime52.jsx)(NextButton, _extends({}, nextButtonProps, {
      children: direction === "rtl" ? (0, import_jsx_runtime52.jsx)(BackPageIcon, {}) : (0, import_jsx_runtime52.jsx)(NextPageIcon, {})
    })), showLastButton && (0, import_jsx_runtime52.jsx)(LastButton, _extends({}, lastButtonProps, {
      children: direction === "rtl" ? (0, import_jsx_runtime52.jsx)(FirstPageIcon, {}) : (0, import_jsx_runtime52.jsx)(LastPageIcon, {})
    }))]
  }));
});
...
var _excluded36 = ["colSpan", "count", "getItemAriaLabel", "labelDisplayedRows", "labelId", "labelRowsPerPage", "onPageChange", "onRowsPerPageChange", "page", "rowsPerPage", "rowsPerPageOptions", "selectId", "slotProps", "slots"];
...
var TablePagination = React75.forwardRef(function TablePagination2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime54.jsx)(Root, _extends({}, rootProps, {
    children: (0, import_jsx_runtime55.jsxs)(Toolbar, _extends({}, toolbarProps, {
      children: [(0, import_jsx_runtime54.jsx)(Spacer, _extends({}, spacerProps)), rowsPerPageOptions.length > 1 && (0, import_jsx_runtime54.jsx)(SelectLabel, _extends({}, selectLabelProps, {
        children: labelRowsPerPage
      })), rowsPerPageOptions.length > 1 && (0, import_jsx_runtime54.jsx)(Select5, _extends({}, selectProps, {
      ...
      })), (0, import_jsx_runtime54.jsx)(DisplayedRows, _extends({}, displayedRowsProps, {
      ...
      })), (0, import_jsx_runtime54.jsx)(Actions, _extends({}, actionsProps))]
    }))
  }));
});
...
function TabsProvider(props) {
  ...
  return (0, import_jsx_runtime56.jsx)(CompoundComponentContext.Provider, {
    value: compoundComponentContextValue,
    children: (0, import_jsx_runtime56.jsx)(TabsContext.Provider, {
...
var _excluded37 = ["children", "value", "defaultValue", "orientation", "direction", "onChange", "selectionFollowsFocus", "slotProps", "slots"];
...
var Tabs = React79.forwardRef(function Tabs2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime57.jsx)(TabsRoot2, _extends({}, tabsRootProps, {
    children: (0, import_jsx_runtime57.jsx)(TabsProvider, {
      value: contextValue,
      children: children2
    })
  }));
...
var _excluded38 = ["children", "value", "slotProps", "slots"];
...
var TabPanel = React81.forwardRef(function TabPanel2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime58.jsx)(TabPanelRoot, _extends({}, tabPanelRootProps, {
...
function TabsListProvider(props) {
  ...
  return (0, import_jsx_runtime59.jsx)(CompoundComponentContext.Provider, {
    value: compoundComponentContextValue,
    children: (0, import_jsx_runtime59.jsx)(ListContext2.Provider, {
      value: listContextValue,
      children: children2
    })
  });
...
var _excluded39 = ["children", "slotProps", "slots"];
...
var TabsList = React84.forwardRef(function TabsList2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime60.jsx)(TabsListProvider, {
    value: contextValue,
    children: (0, import_jsx_runtime60.jsx)(TabsListRoot, _extends({}, tabsListRootProps, {
      children: children2
    }))
  });
});
...
var _excluded40 = ["action", "children", "value", "disabled", "onChange", "onClick", "onFocus", "slotProps", "slots"];
...
var Tab = React86.forwardRef(function Tab2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime61.jsx)(TabRoot2, _extends({}, tabRootProps, {
    children: children2
  }));
});
true ? Tab.propTypes = {
...
var inputGlobalStyles = (0, import_jsx_runtime62.jsx)(GlobalStyles_default2, {
  styles: {
...
var InputBase = React87.forwardRef(function InputBase2(inProps, ref) {
  ...
  const inputRef = React87.useRef();
  const handleInputRefWarning = React87.useCallback((instance) => {
    if (true) {
      if (instance && instance.nodeName !== "INPUT" && !instance.focus) {
  ...
  const checkDirty = React87.useCallback((obj) => {
    if (isFilled(obj)) {
      if (onFilled) {
        onFilled();
      }
  ...
  return (0, import_jsx_runtime63.jsxs)(React87.Fragment, {
...
var Input3 = React88.forwardRef(function Input4(inProps, ref) {
  ...
  return (0, import_jsx_runtime64.jsx)(InputBase_default, _extends({
    slots: {
      root: RootSlot,
      input: InputSlot
    },
...
var FilledInput = React89.forwardRef(function FilledInput2(inProps, ref) {
  var _ref, _slots$root, _ref2, _slots$input;
  const props = useThemeProps({
    props: inProps,
    name: "MuiFilledInput"
  ...
  return (0, import_jsx_runtime65.jsx)(InputBase_default, _extends({
    slots: {
      root: RootSlot,
      input: InputSlot
    },
...
function NotchedOutline(props) {
  ...
  return (0, import_jsx_runtime66.jsx)(NotchedOutlineRoot, _extends({
    "aria-hidden": true,
    className,
    ownerState
  }, other, {
    children: (0, import_jsx_runtime66.jsx)(NotchedOutlineLegend, {
      ownerState,
      children: withLabel ? (0, import_jsx_runtime66.jsx)("span", {
        children: label
      }) : (
        // notranslate needed while Google Translate will not fix zero-width space issue
        _span5 || (_span5 = (0, import_jsx_runtime66.jsx)("span", {
...
var OutlinedInput = React91.forwardRef(function OutlinedInput2(inProps, ref) {
  ...
  return (0, import_jsx_runtime68.jsx)(InputBase_default, _extends({
    ...
    renderSuffix: (state) => (0, import_jsx_runtime68.jsx)(NotchedOutlineRoot2, {
      ownerState,
      className: classes.notchedOutline,
      label: label != null && label !== "" && fcs.required ? _React$Fragment || (_React$Fragment = (0, import_jsx_runtime67.jsxs)(React91.Fragment, {
        children: [label, " ", "*"]
      })) : label,
...
var FormLabel = React92.forwardRef(function FormLabel2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiFormLabel"
  });
  ...
  return (0, import_jsx_runtime69.jsxs)(FormLabelRoot, _extends({
    as: component,
    ownerState,
    className: clsx_default(classes.root, className),
    ref
  }, other, {
    children: [children2, fcs.required && (0, import_jsx_runtime69.jsxs)(AsteriskComponent, {
      ownerState,
      "aria-hidden": true,
...
var InputLabel = React93.forwardRef(function InputLabel2(inProps, ref) {
  const props = useThemeProps({
    name: "MuiInputLabel",
    props: inProps
  });
  ...
  return (0, import_jsx_runtime70.jsx)(InputLabelRoot, _extends({
    "data-shrink": shrink,
    ownerState,
    ref,
    className: clsx_default(classes.root, className)
...
var FormControl3 = React94.forwardRef(function FormControl4(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiFormControl"
  });
  ...
  const [adornedStart, setAdornedStart] = React94.useState(() => {
    let initialAdornedStart = false;
    if (children2) {
      React94.Children.forEach(children2, (child) => {
  ...
  const [filled, setFilled] = React94.useState(() => {
  ...
  const [focusedState, setFocused] = React94.useState(false);
  ...
  let registerEffect;
  if (true) {
    const registeredInput = React94.useRef(false);
    registerEffect = () => {
...
var FormHelperText = React95.forwardRef(function FormHelperText2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiFormHelperText"
  });
  ...
  return (0, import_jsx_runtime72.jsx)(FormHelperTextRoot, _extends({
    ...
    children: children2 === " " ? (
      // notranslate needed while Google Translate will not fix zero-width space issue
      _span6 || (_span6 = (0, import_jsx_runtime72.jsx)("span", {
        className: "notranslate",
        children: "​"
      }))
    ) : children2
...
var Grow = React96.forwardRef(function Grow2(props, ref) {
  const {
    addEndListener,
    appear = true,
    children: children2,
  ...
  const timer = React96.useRef();
  const autoTimeout = React96.useRef();
  ...
  return (0, import_jsx_runtime73.jsx)(TransitionComponent, _extends({
    ...
    children: (state, childProps) => {
      return React96.cloneElement(children2, _extends({
        style: _extends({
          opacity: 0,
...
var _excluded51 = ["addEndListener", "appear", "children", "easing", "in", "onEnter", "onEntered", "onEntering", "onExit", "onExited", "onExiting", "style", "timeout", "TransitionComponent"];
var styles3 = {
  entering: {
    opacity: 1
  },
...
var Fade = React97.forwardRef(function Fade2(props, ref) {
  const theme = useTheme();
  ...
  return (0, import_jsx_runtime74.jsx)(TransitionComponent, _extends({
    ...
    children: (state, childProps) => {
      return React97.cloneElement(children2, _extends({
        style: _extends({
          opacity: 0,
          visibility: state === "exited" && !inProp ? "hidden" : void 0
...
var _excluded52 = ["children", "className", "component", "components", "componentsProps", "invisible", "open", "slotProps", "slots", "TransitionComponent", "transitionDuration"];
...
var Backdrop = React98.forwardRef(function Backdrop2(inProps, ref) {
  ...
  return (0, import_jsx_runtime75.jsx)(TransitionComponent, _extends({
    ...
    children: (0, import_jsx_runtime75.jsx)(BackdropRoot, _extends({
      "aria-hidden": true
    }, rootSlotProps, {
...
var _excluded53 = ["BackdropComponent", "BackdropProps", "classes", "className", "closeAfterTransition", "children", "container", "component", "components", "componentsProps", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted", "onBackdropClick", "onClose", "open", "slotProps", "slots", "theme"];
...
var Modal3 = React99.forwardRef(function Modal4(inProps, ref) {
  ...
  return (0, import_jsx_runtime76.jsx)(Modal, _extends({
    slots: {
      root: RootSlot,
...
true ? Modal3.propTypes = {
   ...
   * })
   */
  BackdropComponent: import_prop_types57.default.elementType,
  /**
   * Props applied to the [`Backdrop`](/material-ui/api/backdrop/) element.
   * @deprecated Use `slotProps.backdrop` instead.
   */
  BackdropProps: import_prop_types57.default.object,
  /**
   * A single child content element.
   */
  children: elementAcceptingRef_default.isRequired,
   ...
   * @default false
   */
  closeAfterTransition: import_prop_types57.default.bool,
  /**
   * The component used for the root node.
   * Either a string to use a HTML element or a component.
   */
   ...
   * @default false
   */
  disableAutoFocus: import_prop_types57.default.bool,
  /**
   * If `true`, the modal will not prevent focus from leaving the modal while open.
   *
   * Generally this should never be set to `true` as it makes the modal less
   ...
   * @default false
   */
  disableEnforceFocus: import_prop_types57.default.bool,
  /**
   * If `true`, hitting escape will not fire the `onClose` callback.
   * @default false
   */
  disableEscapeKeyDown: import_prop_types57.default.bool,
  /**
   * The `children` will be under the DOM hierarchy of the parent component.
   * @default false
   */
   ...
   * @default false
   */
  disableRestoreFocus: import_prop_types57.default.bool,
  /**
   * Disable the scroll lock behavior.
   * @default false
   */
  disableScrollLock: import_prop_types57.default.bool,
  /**
   * If `true`, the backdrop is not rendered.
   * @default false
   */
   ...
   * @deprecated Use the `onClose` prop with the `reason` argument to handle the `backdropClick` events.
   */
  onBackdropClick: import_prop_types57.default.func,
  /**
   * Callback fired when the component requests to be closed.
   * The `reason` parameter can optionally be used to control the response to `onClose`.
   *
   ...
   * A function called when a transition enters.
   */
  onTransitionEnter: import_prop_types57.default.func,
  /**
   * A function called when a transition has exited.
   */
  onTransitionExited: import_prop_types57.default.func,
  /**
   * If `true`, the component is shown.
   */
...
var _excluded54 = ["className", "component", "elevation", "square", "variant"];
...
var Paper = React100.forwardRef(function Paper2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPaper"
  });
  ...
  return (0, import_jsx_runtime77.jsx)(PaperRoot, _extends({
    as: component,
    ownerState,
    className: clsx_default(classes.root, className),
    ref
...
true ? Paper.propTypes = {
   ...
   * @default false
   */
  square: import_prop_types58.default.bool,
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   */
   ...
   * @default 'elevation'
   */
  variant: import_prop_types58.default.oneOfType([import_prop_types58.default.oneOf(["elevation", "outlined"]), import_prop_types58.default.string])
} : void 0;
...
var Popover = React101.forwardRef(function Popover2(inProps, ref) {
  ...
  } = props, TransitionProps = _objectWithoutPropertiesLoose(props.TransitionProps, _excluded55), other = _objectWithoutPropertiesLoose(props, _excluded210);
  ...
  const getAnchorOffset = React101.useCallback(() => {
  ...
  const getTransformOrigin = React101.useCallback((elemRect) => {
    return {
      vertical: getOffsetTop(elemRect, transformOrigin.vertical),
      horizontal: getOffsetLeft(elemRect, transformOrigin.horizontal)
    };
  }, [transformOrigin.horizontal, transformOrigin.vertical]);
  const getPositioningStyle = React101.useCallback((element) => {
    const elemRect = {
  ...
  const [isPositioned, setIsPositioned] = React101.useState(open);
  const setPositioningStyles = React101.useCallback(() => {
  ...
  React101.useImperativeHandle(action, () => open ? {
    updatePosition: () => {
      setPositioningStyles();
    }
  ...
  return (0, import_jsx_runtime78.jsx)(RootSlot, _extends({}, rootProps, !isHostComponent(RootSlot) && {
    slotProps: rootSlotPropsProp
  }, {
    children: (0, import_jsx_runtime78.jsx)(TransitionComponent, _extends({
      appear: true,
      in: open,
      onEntering: handleEntering,
      onExited: handleExited,
      ...
      children: (0, import_jsx_runtime78.jsx)(PaperSlot, _extends({}, paperProps, {
        children: children2
      }))
    }))
  }));
...
true ? Popover.propTypes = {
   ...
   */
  anchorEl: chainPropTypes(import_prop_types59.default.oneOfType([HTMLElementType, import_prop_types59.default.func]), (props) => {
  ...
  anchorOrigin: import_prop_types59.default.shape({
    horizontal: import_prop_types59.default.oneOfType([import_prop_types59.default.oneOf(["center", "left", "right"]), import_prop_types59.default.number]).isRequired,
    vertical: import_prop_types59.default.oneOfType([import_prop_types59.default.oneOf(["bottom", "center", "top"]), import_prop_types59.default.number]).isRequired
  }),
  /**
   * This is the position that may be used to set the position of the popover.
   * The coordinates are relative to the application's client area.
   */
  anchorPosition: import_prop_types59.default.shape({
    left: import_prop_types59.default.number.isRequired,
    top: import_prop_types59.default.number.isRequired
  }),
  /**
   ...
   * @default 'anchorEl'
   */
  anchorReference: import_prop_types59.default.oneOf(["anchorEl", "anchorPosition", "none"]),
  /**
   * The content of the component.
   */
   ...
   * @default 16
   */
  marginThreshold: import_prop_types59.default.number,
  /**
   * Callback fired when the component requests to be closed.
   * The `reason` parameter can optionally be used to control the response to `onClose`.
   */
   ...
   * @default {}
   */
  PaperProps: import_prop_types59.default.shape({
    component: elementTypeAcceptingRef_default
  }),
  /**
   * The extra props for the slot components.
   ...
   * }
   */
  transformOrigin: import_prop_types59.default.shape({
    horizontal: import_prop_types59.default.oneOfType([import_prop_types59.default.oneOf(["center", "left", "right"]), import_prop_types59.default.number]).isRequired,
    vertical: import_prop_types59.default.oneOfType([import_prop_types59.default.oneOf(["bottom", "center", "top"]), import_prop_types59.default.number]).isRequired
  }),
  /**
...
var Menu3 = React102.forwardRef(function Menu4(inProps, ref) {
  ...
  const {
    ...
    slots = {},
    slotProps = {}
  } = props, TransitionProps = _objectWithoutPropertiesLoose(props.TransitionProps, _excluded56), other = _objectWithoutPropertiesLoose(props, _excluded211);
  const theme = useTheme();
  ...
  const menuListActionsRef = React102.useRef(null);
  const handleEntering = (element, isAppearing) => {
  ...
  let activeItemIndex = -1;
  React102.Children.map(children2, (child, index) => {
  ...
  return (0, import_jsx_runtime79.jsx)(MenuRoot, _extends({
    onClose,
    anchorOrigin: {
      vertical: "bottom",
    ...
    children: (0, import_jsx_runtime79.jsx)(MenuMenuList, _extends({
...
true ? Menu3.propTypes = {
   ...
   */
  anchorEl: import_prop_types60.default.oneOfType([HTMLElementType, import_prop_types60.default.func]),
  /**
   ...
   * @default false
   */
  disableAutoFocusItem: import_prop_types60.default.bool,
  /**
   * Props applied to the [`MenuList`](/material-ui/api/menu-list/) element.
   * @default {}
   */
  MenuListProps: import_prop_types60.default.object,
  /**
   * Callback fired when the component requests to be closed.
   *
   * @param {object} event The event source of the callback.
   ...
   * @ignore
   */
  PaperProps: import_prop_types60.default.object,
  /**
   * `classes` prop applied to the [`Popover`](/material-ui/api/popover/) element.
   */
  PopoverClasses: import_prop_types60.default.object,
  /**
   * The extra props for the slot components.
   * You can override the existing props or add new ones.
   *
  ...
  slotProps: import_prop_types60.default.shape({
    paper: import_prop_types60.default.oneOfType([import_prop_types60.default.func, import_prop_types60.default.object]),
  ...
  slots: import_prop_types60.default.shape({
    paper: import_prop_types60.default.elementType,
   ...
   * @default 'auto'
   */
  transitionDuration: import_prop_types60.default.oneOfType([import_prop_types60.default.oneOf(["auto"]), import_prop_types60.default.number, import_prop_types60.default.shape({
...
var _excluded57 = ["className", "disabled", "error", "IconComponent", "inputRef", "variant"];
...
var NativeSelectInput = React103.forwardRef(function NativeSelectInput2(props, ref) {
  const {
    className,
    disabled,
    error,
  ...
  return (0, import_jsx_runtime81.jsxs)(React103.Fragment, {
    children: [(0, import_jsx_runtime80.jsx)(NativeSelectSelect, _extends({
      ownerState,
      className: clsx_default(classes.select, className),
      disabled,
      ref: inputRef || ref
    }, other)), props.multiple ? null : (0, import_jsx_runtime80.jsx)(NativeSelectIcon, {
      as: IconComponent,
      ownerState,
...
var _span7;
var _excluded58 = ["aria-describedby", "aria-label", "autoFocus", "autoWidth", "children", "className", "defaultOpen", "defaultValue", "disabled", "displayEmpty", "error", "IconComponent", "inputRef", "labelId", "MenuProps", "multiple", "name", "onBlur", "onChange", "onClose", "onFocus", "onOpen", "open", "readOnly", "renderValue", "SelectDisplayProps", "tabIndex", "type", "value", "variant"];
...
var SelectInput = React104.forwardRef(function SelectInput2(props, ref) {
  const {
    "aria-describedby": ariaDescribedby,
    "aria-label": ariaLabel,
    autoFocus,
  ...
  const inputRef = React104.useRef(null);
  const displayRef = React104.useRef(null);
  const [displayNode, setDisplayNode] = React104.useState(null);
  const {
    current: isOpenControlled
  } = React104.useRef(openProp != null);
  const [menuMinWidthState, setMenuMinWidthState] = React104.useState();
  const handleRef = useForkRef_default(ref, inputRefProp);
  const handleDisplayRef = React104.useCallback((node) => {
  ...
  React104.useImperativeHandle(handleRef, () => ({
    focus: () => {
  ...
  const childrenArray = React104.Children.toArray(children2);
  const handleChange = (event) => {
  ...
  return (0, import_jsx_runtime83.jsxs)(React104.Fragment, {
    children: [(0, import_jsx_runtime82.jsx)(SelectSelect, _extends({
      ...
      children: isEmpty2(display) ? (
        // notranslate needed while Google Translate will not fix zero-width space issue
        _span7 || (_span7 = (0, import_jsx_runtime82.jsx)("span", {
          className: "notranslate",
          children: "​"
        }))
      ) : display
...
true ? SelectInput.propTypes = {
   ...
   * @ignore
   */
  "aria-describedby": import_prop_types62.default.string,
  /**
   * @ignore
   */
   ...
   * @ignore
   */
  tabIndex: import_prop_types62.default.oneOfType([import_prop_types62.default.number, import_prop_types62.default.string]),
  /**
   * @ignore
   */
  type: import_prop_types62.default.any,
  /**
   * The input value.
   */
...
var ArrowDropDown_default = createSvgIcon((0, import_jsx_runtime84.jsx)("path", {
  d: "M7 10l5 5 5-5z"
}), "ArrowDropDown");
...
var _excluded59 = ["autoWidth", "children", "classes", "className", "defaultOpen", "displayEmpty", "IconComponent", "id", "input", "inputProps", "label", "labelId", "MenuProps", "multiple", "native", "onClose", "onOpen", "open", "renderValue", "SelectDisplayProps", "variant"];
...
var Select3 = React106.forwardRef(function Select4(inProps, ref) {
  const props = useThemeProps({
    name: "MuiSelect",
    props: inProps
  });
  ...
  const InputComponent = input || {
    standard: (0, import_jsx_runtime85.jsx)(StyledInput, {
      ownerState
    }),
    outlined: (0, import_jsx_runtime85.jsx)(StyledOutlinedInput, {
      label,
      ownerState
    }),
    filled: (0, import_jsx_runtime85.jsx)(StyledFilledInput, {
      ownerState
    })
  }[variant];
  const inputComponentRef = useForkRef_default(ref, InputComponent.ref);
  return (0, import_jsx_runtime85.jsx)(React106.Fragment, {
    children: React106.cloneElement(InputComponent, _extends({
...
true ? Select3.propTypes = {
   ...
   * @default false
   */
  native: import_prop_types63.default.bool,
  /**
   * Callback fired when a menu item is selected.
   *
   ...
   */
  value: import_prop_types63.default.oneOfType([import_prop_types63.default.oneOf([""]), import_prop_types63.default.any]),
  /**
   * The variant to use.
   * @default 'outlined'
   */
...
var TextField = React107.forwardRef(function TextField2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTextField"
  });
  ...
  const InputElement = (0, import_jsx_runtime86.jsx)(InputComponent, _extends({
  ...
  return (0, import_jsx_runtime87.jsxs)(TextFieldRoot, _extends({
    className: clsx_default(classes.root, className),
    disabled,
    error,
    fullWidth,
    ...
    children: [label != null && label !== "" && (0, import_jsx_runtime86.jsx)(InputLabel_default, _extends({
      htmlFor: id,
      id: inputLabelId
    }, InputLabelProps, {
      children: label
    })), select ? (0, import_jsx_runtime86.jsx)(Select_default, _extends({
      "aria-describedby": helperTextId,
      id,
      ...
      children: children2
    })) : InputElement, helperText && (0, import_jsx_runtime86.jsx)(FormHelperText_default, _extends({
      id: helperTextId
    }, FormHelperTextProps, {
      children: helperText
    }))]
...
function useMediaQueryOld(query, defaultMatches, matchMedia, ssrMatchMedia, noSsr) {
  const [match, setMatch] = React108.useState(() => {
    if (noSsr && matchMedia) {
...
var maybeReactUseSyncExternalStore = React108["useSyncExternalStore"];
function useMediaQueryNew(query, defaultMatches, matchMedia, ssrMatchMedia, noSsr) {
  const getDefaultSnapshot = React108.useCallback(() => defaultMatches, [defaultMatches]);
  const getServerSnapshot = React108.useMemo(() => {
    if (noSsr && matchMedia) {
      return () => matchMedia(query).matches;
    }
  ...
  const [getSnapshot, subscribe] = React108.useMemo(() => {
    if (matchMedia === null) {
      return [getDefaultSnapshot, () => () => {
      }];
    }
...
var Skeleton = React109.forwardRef(function Skeleton2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiSkeleton"
  });
...
var GridContext = React110.createContext();
if (true) {
...
var _excluded62 = ["className", "columns", "columnSpacing", "component", "container", "direction", "item", "rowSpacing", "spacing", "wrap", "zeroMinWidth"];
...
var Grid = React111.forwardRef(function Grid2(inProps, ref) {
  const themeProps = useThemeProps({
    props: inProps,
    name: "MuiGrid"
  });
  ...
  const columnsContext = React111.useContext(GridContext_default);
  ...
  return (0, import_jsx_runtime89.jsx)(GridContext_default.Provider, {
    value: columns,
    children: (0, import_jsx_runtime89.jsx)(GridRoot, _extends({
      ownerState,
      className: clsx_default(classes.root, className),
      as: component,
      ref
...
var _excluded63 = ["className", "dividers"];
...
var DialogContent = React112.forwardRef(function DialogContent2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiDialogContent"
  });
  ...
  return (0, import_jsx_runtime90.jsx)(DialogContentRoot, _extends({
    className: clsx_default(classes.root, className),
    ownerState,
    ref
  }, other));
...
true ? DialogContent.propTypes = {
   ...
   * @default false
   */
  dividers: import_prop_types67.default.bool,
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   */
...
var DialogContext = React113.createContext({});
if (true) {
...
var _excluded64 = ["aria-describedby", "aria-labelledby", "BackdropComponent", "BackdropProps", "children", "className", "disableEscapeKeyDown", "fullScreen", "fullWidth", "maxWidth", "onBackdropClick", "onClose", "open", "PaperComponent", "PaperProps", "scroll", "TransitionComponent", "transitionDuration", "TransitionProps"];
...
var Dialog = React114.forwardRef(function Dialog2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiDialog"
  });
  ...
  const backdropClick = React114.useRef();
  const handleMouseDown = (event) => {
  ...
  const dialogContextValue = React114.useMemo(() => {
    return {
      titleId: ariaLabelledby
    };
  }, [ariaLabelledby]);
  return (0, import_jsx_runtime91.jsx)(DialogRoot, _extends({
    className: clsx_default(classes.root, className),
    ...
    children: (0, import_jsx_runtime91.jsx)(TransitionComponent, _extends({
      ...
      children: (0, import_jsx_runtime91.jsx)(DialogContainer, {
        className: clsx_default(classes.container),
        onMouseDown: handleMouseDown,
        ownerState,
        children: (0, import_jsx_runtime91.jsx)(DialogPaper, _extends({
          as: PaperComponent,
          elevation: 24,
          role: "dialog",
          "aria-describedby": ariaDescribedby,
          ...
          ownerState,
          children: (0, import_jsx_runtime91.jsx)(DialogContext_default.Provider, {
...
true ? Dialog.propTypes = {
   ...
   * })
   */
  BackdropComponent: import_prop_types68.default.elementType,
  /**
   * @ignore
   */
  BackdropProps: import_prop_types68.default.object,
  /**
   ...
   * @default false
   */
  disableEscapeKeyDown: import_prop_types68.default.bool,
  /**
   * If `true`, the dialog is full-screen.
   * @default false
   */
  fullScreen: import_prop_types68.default.bool,
  /**
   ...
   * @default 'sm'
   */
  maxWidth: import_prop_types68.default.oneOfType([import_prop_types68.default.oneOf(["xs", "sm", "md", "lg", "xl", false]), import_prop_types68.default.string]),
  /**
   * Callback fired when the backdrop is clicked.
   * @deprecated Use the `onClose` prop with the `reason` argument to handle the `backdropClick` events.
   */
  onBackdropClick: import_prop_types68.default.func,
  /**
   * Callback fired when the component requests to be closed.
   *
   * @param {object} event The event source of the callback.
   ...
   * @default 'paper'
   */
  scroll: import_prop_types68.default.oneOf(["body", "paper"]),
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   */
...
var _excluded65 = ["anchorEl", "component", "components", "componentsProps", "container", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "transition", "slots", "slotProps"];
var PopperRoot = styled_default(Popper, {
  name: "MuiPopper",
  slot: "Root",
  overridesResolver: (props, styles5) => styles5.root
})({});
var Popper3 = React115.forwardRef(function Popper4(inProps, ref) {
  var _slots$root;
  const theme = useThemeWithoutDefault_default();
  const props = useThemeProps({
    props: inProps,
  ...
  return (0, import_jsx_runtime92.jsx)(PopperRoot, _extends({
    as: component,
...
var Button3 = React117.forwardRef(function Button4(inProps, ref) {
  const contextProps = React117.useContext(ButtonGroupContext_default);
  ...
  const startIcon = startIconProp && (0, import_jsx_runtime93.jsx)(ButtonStartIcon, {
    className: classes.startIcon,
    ownerState,
    children: startIconProp
  });
  const endIcon = endIconProp && (0, import_jsx_runtime93.jsx)(ButtonEndIcon, {
    className: classes.endIcon,
    ownerState,
    children: endIconProp
  });
  return (0, import_jsx_runtime94.jsxs)(ButtonRoot, _extends({
    ownerState,
...
true ? Button3.propTypes = {
   ...
   * @default 'primary'
   */
  color: import_prop_types70.default.oneOfType([import_prop_types70.default.oneOf(["inherit", "primary", "secondary", "success", "error", "info", "warning"]), import_prop_types70.default.string]),
  /**
   * The component used for the root node.
   * Either a string to use a HTML element or a component.
   */
   ...
   * @default false
   */
  disableElevation: import_prop_types70.default.bool,
  /**
   * If `true`, the  keyboard focus ripple is disabled.
   * @default false
   */
   ...
   */
  endIcon: import_prop_types70.default.node,
  /**
   * @ignore
   */
   ...
   */
  href: import_prop_types70.default.string,
  /**
   * The size of the component.
   * `small` is equivalent to the dense button styling.
   * @default 'medium'
   ...
   */
  startIcon: import_prop_types70.default.node,
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   */
   ...
   * @ignore
   */
  type: import_prop_types70.default.oneOfType([import_prop_types70.default.oneOf(["button", "reset", "submit"]), import_prop_types70.default.string]),
  /**
   * The variant to use.
   * @default 'text'
   */
  variant: import_prop_types70.default.oneOfType([import_prop_types70.default.oneOf(["contained", "outlined", "text"]), import_prop_types70.default.string])
} : void 0;
...
var _excluded67 = ["className", "disableSpacing"];
...
var DialogActions = React118.forwardRef(function DialogActions2(inProps, ref) {
  ...
  return (0, import_jsx_runtime95.jsx)(DialogActionsRoot, _extends({
    className: clsx_default(classes.root, className),
    ownerState,
    ref
  }, other));
...
var _excluded68 = ["alignItems", "autoFocus", "component", "children", "dense", "disableGutters", "divider", "focusVisibleClassName", "selected", "className"];
...
var ListItemButton = React119.forwardRef(function ListItemButton2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiListItemButton"
  });
  ...
  const context = React119.useContext(ListContext_default);
  const childContext = React119.useMemo(() => ({
    dense: dense || context.dense || false,
    alignItems,
    disableGutters
  }), [alignItems, context.dense, dense, disableGutters]);
  const listItemRef = React119.useRef(null);
  useEnhancedEffect_default2(() => {
    if (autoFocus) {
  ...
  return (0, import_jsx_runtime96.jsx)(ListContext_default.Provider, {
    value: childContext,
    children: (0, import_jsx_runtime96.jsx)(ListItemButtonRoot, _extends({
      ref: handleRef,
...
var ListItemSecondaryAction = React120.forwardRef(function ListItemSecondaryAction2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiListItemSecondaryAction"
  });
  ...
  const context = React120.useContext(ListContext_default);
  const ownerState = _extends({}, props, {
    disableGutters: context.disableGutters
  });
  const classes = useUtilityClasses53(ownerState);
  return (0, import_jsx_runtime97.jsx)(ListItemSecondaryActionRoot, _extends({
    className: clsx_default(classes.root, className),
    ownerState,
    ref
  }, other));
...
var ListItem = React121.forwardRef(function ListItem2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiListItem"
  });
  const {
    ...
    slotProps = {},
    slots = {}
  } = props, ContainerProps = _objectWithoutPropertiesLoose(props.ContainerProps, _excluded70), other = _objectWithoutPropertiesLoose(props, _excluded212);
  const context = React121.useContext(ListContext_default);
  const childContext = React121.useMemo(() => ({
    dense: dense || context.dense || false,
    alignItems,
    disableGutters
  }), [alignItems, context.dense, dense, disableGutters]);
  const listItemRef = React121.useRef(null);
  useEnhancedEffect_default2(() => {
    if (autoFocus) {
      if (listItemRef.current) {
        listItemRef.current.focus();
  ...
  const children2 = React121.Children.toArray(childrenProp);
  ...
  if (hasSecondaryAction) {
    ...
    return (0, import_jsx_runtime98.jsx)(ListContext_default.Provider, {
      value: childContext,
      children: (0, import_jsx_runtime99.jsxs)(ListItemContainer, _extends({
        as: ContainerComponent,
        className: clsx_default(classes.container, ContainerClassName),
        ref: handleRef,
        ownerState
      }, ContainerProps, {
        children: [(0, import_jsx_runtime98.jsx)(Root, _extends({}, rootProps, !isHostComponent(Root) && {
          as: Component,
          ownerState: _extends({}, ownerState, rootProps.ownerState)
        }, componentProps, {
          children: children2
  ...
  return (0, import_jsx_runtime98.jsx)(ListContext_default.Provider, {
    value: childContext,
    children: (0, import_jsx_runtime99.jsxs)(Root, _extends({}, rootProps, {
      as: Component,
      ref: handleRef
    }, !isHostComponent(Root) && {
      ownerState: _extends({}, ownerState, rootProps.ownerState)
    }, componentProps, {
      children: [children2, secondaryAction && (0, import_jsx_runtime98.jsx)(ListItemSecondaryAction_default, {
...
true ? ListItem.propTypes = {
  ...
  children: chainPropTypes(import_prop_types74.default.node, (props) => {
    const children2 = React121.Children.toArray(props.children);
...
var Cancel_default = createSvgIcon((0, import_jsx_runtime100.jsx)("path", {
...
var _excluded71 = ["avatar", "className", "clickable", "color", "component", "deleteIcon", "disabled", "icon", "label", "onClick", "onDelete", "onKeyDown", "onKeyUp", "size", "variant", "tabIndex", "skipFocusWhenDisabled"];
...
var Chip = React123.forwardRef(function Chip2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiChip"
  });
  ...
  const chipRef = React123.useRef(null);
  ...
  const ownerState = _extends({}, props, {
    ...
    size,
    color,
    iconColor: React123.isValidElement(iconProp) ? iconProp.props.color || color : color,
    onDelete: !!onDelete,
    clickable,
    variant
  });
  ...
  let deleteIcon = null;
  if (onDelete) {
    deleteIcon = deleteIconProp && React123.isValidElement(deleteIconProp) ? React123.cloneElement(deleteIconProp, {
      className: clsx_default(deleteIconProp.props.className, classes.deleteIcon),
      onClick: handleDeleteIconClick
    }) : (0, import_jsx_runtime101.jsx)(Cancel_default, {
      className: clsx_default(classes.deleteIcon),
      onClick: handleDeleteIconClick
    });
  }
  let avatar = null;
  if (avatarProp && React123.isValidElement(avatarProp)) {
    avatar = React123.cloneElement(avatarProp, {
      className: clsx_default(classes.avatar, avatarProp.props.className)
    });
  }
  let icon = null;
  if (iconProp && React123.isValidElement(iconProp)) {
    icon = React123.cloneElement(iconProp, {
  ...
  return (0, import_jsx_runtime102.jsxs)(ChipRoot, _extends({
    as: component,
    className: clsx_default(classes.root, className),
    ...
    children: [avatar || icon, (0, import_jsx_runtime101.jsx)(ChipLabel, {
...
true ? Chip.propTypes = {
   ...
   */
  avatar: import_prop_types75.default.element,
  /**
   ...
   */
  clickable: import_prop_types75.default.bool,
  /**
   * The color of the component.
   * It supports both default and custom theme colors, which can be added as shown in the
   * [palette customization guide](https://mui.com/material-ui/customization/palette/#adding-new-colors).
   ...
   */
  deleteIcon: import_prop_types75.default.element,
  /**
   * If `true`, the component is disabled.
   * @default false
   */
   ...
   * Icon element.
   */
  icon: import_prop_types75.default.element,
  /**
   * The content of the component.
   */
   ...
   */
  onDelete: import_prop_types75.default.func,
  /**
   * @ignore
   */
  onKeyDown: import_prop_types75.default.func,
  /**
   * @ignore
   */
  onKeyUp: import_prop_types75.default.func,
  /**
   * The size of the component.
   * @default 'medium'
   */
   ...
   * @default false
   */
  skipFocusWhenDisabled: import_prop_types75.default.bool,
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   */
   ...
   * @default 'filled'
   */
  variant: import_prop_types75.default.oneOfType([import_prop_types75.default.oneOf(["filled", "outlined"]), import_prop_types75.default.string])
} : void 0;
...
var _span8;
var _excluded72 = ["children", "className", "component", "disablePointerEvents", "disableTypography", "position", "variant"];
...
var InputAdornment = React124.forwardRef(function InputAdornment2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiInputAdornment"
  });
  ...
  return (0, import_jsx_runtime103.jsx)(FormControlContext_default.Provider, {
    value: null,
    children: (0, import_jsx_runtime103.jsx)(InputAdornmentRoot, _extends({
      as: component,
      ownerState,
      className: clsx_default(classes.root, className),
      ref
    }, other, {
      children: typeof children2 === "string" && !disableTypography ? (0, import_jsx_runtime103.jsx)(Typography_default, {
        color: "text.secondary",
        children: children2
      }) : (0, import_jsx_runtime104.jsxs)(React124.Fragment, {
        children: [position === "start" ? (
          /* notranslate needed while Google Translate will not fix zero-width space issue */
          _span8 || (_span8 = (0, import_jsx_runtime103.jsx)("span", {
            className: "notranslate",
            children: "​"
          }))
        ) : null, children2]
...
var Tab3 = React125.forwardRef(function Tab4(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTab"
  });
  ...
  const icon = iconProp && label && React125.isValidElement(iconProp) ? React125.cloneElement(iconProp, {
  ...
  return (0, import_jsx_runtime105.jsxs)(TabRoot, _extends({
    focusRipple: !disableFocusRipple,
    className: clsx_default(classes.root, className),
    ref,
    role: "tab",
    ...
    children: [iconPosition === "top" || iconPosition === "start" ? (0, import_jsx_runtime105.jsxs)(React125.Fragment, {
      children: [icon, label]
    }) : (0, import_jsx_runtime105.jsxs)(React125.Fragment, {
      children: [label, icon]
    }), indicator]
  }));
});
...
var KeyboardArrowLeft_default = createSvgIcon((0, import_jsx_runtime106.jsx)("path", {
...
var KeyboardArrowRight_default = createSvgIcon((0, import_jsx_runtime107.jsx)("path", {
...
var _excluded74 = ["className", "slots", "slotProps", "direction", "orientation", "disabled"];
...
var TabScrollButton = React128.forwardRef(function TabScrollButton2(inProps, ref) {
  ...
  return (0, import_jsx_runtime108.jsx)(TabScrollButtonRoot, _extends({
    component: "div",
    className: clsx_default(classes.root, className),
    ref,
    role: null,
    ...
    children: direction === "left" ? (0, import_jsx_runtime108.jsx)(StartButtonIcon, _extends({}, startButtonIconProps)) : (0, import_jsx_runtime108.jsx)(EndButtonIcon, _extends({}, endButtonIconProps))
  }));
});
...
function ScrollbarSize(props) {
  ...
  const scrollbarHeight = React129.useRef();
  const nodeRef = React129.useRef(null);
  ...
  return (0, import_jsx_runtime109.jsx)("div", _extends({
    style: styles4,
    ref: nodeRef
  }, other));
}
...
var _excluded76 = ["aria-label", "aria-labelledby", "action", "centered", "children", "className", "component", "allowScrollButtonsMobile", "indicatorColor", "onChange", "orientation", "ScrollButtonComponent", "scrollButtons", "selectionFollowsFocus", "slots", "slotProps", "TabIndicatorProps", "TabScrollButtonProps", "textColor", "value", "variant", "visibleScrollbar"];
...
var Tabs3 = React130.forwardRef(function Tabs4(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTabs"
  });
  ...
  const [mounted, setMounted] = React130.useState(false);
  const [indicatorStyle, setIndicatorStyle] = React130.useState(defaultIndicatorStyle);
  const [displayStartScroll, setDisplayStartScroll] = React130.useState(false);
  const [displayEndScroll, setDisplayEndScroll] = React130.useState(false);
  const [updateScrollObserver, setUpdateScrollObserver] = React130.useState(false);
  const [scrollerStyle, setScrollerStyle] = React130.useState({
    overflow: "hidden",
    scrollbarWidth: 0
  });
  const valueToIndex = /* @__PURE__ */ new Map();
  const tabsRef = React130.useRef(null);
  const tabListRef = React130.useRef(null);
  const getTabsMeta = () => {
  ...
  const handleScrollbarSizeChange = React130.useCallback((scrollbarWidth) => {
    setScrollerStyle({
      overflow: null,
      scrollbarWidth
    });
  ...
  const getConditionalElements = () => {
    ...
    conditionalElements2.scrollbarSizeListener = scrollable ? (0, import_jsx_runtime110.jsx)(TabsScrollbarSize, {
      onChange: handleScrollbarSizeChange,
      className: clsx_default(classes.scrollableX, classes.hideScrollbar)
    }) : null;
    const scrollButtonsActive = displayStartScroll || displayEndScroll;
    const showScrollButtons = scrollable && (scrollButtons === "auto" && scrollButtonsActive || scrollButtons === true);
    conditionalElements2.scrollButtonStart = showScrollButtons ? (0, import_jsx_runtime110.jsx)(ScrollButtonComponent, _extends({
      slots: {
    ...
    conditionalElements2.scrollButtonEnd = showScrollButtons ? (0, import_jsx_runtime110.jsx)(ScrollButtonComponent, _extends({
      slots: {
  ...
  React130.useImperativeHandle(action, () => ({
    updateIndicator: updateIndicatorState,
    updateScrollButtons: updateScrollButtonState
  }), [updateIndicatorState, updateScrollButtonState]);
  const indicator = (0, import_jsx_runtime110.jsx)(TabsIndicator, _extends({}, TabIndicatorProps, {
    className: clsx_default(classes.indicator, TabIndicatorProps.className),
    ownerState,
    style: _extends({}, indicatorStyle, TabIndicatorProps.style)
  }));
  let childIndex = 0;
  const children2 = React130.Children.map(childrenProp, (child) => {
  ...
  return (0, import_jsx_runtime111.jsxs)(TabsRoot, _extends({
    className: clsx_default(classes.root, className),
    ownerState,
    ref,
    as: component
  }, other, {
    children: [conditionalElements.scrollButtonStart, conditionalElements.scrollbarSizeListener, (0, import_jsx_runtime111.jsxs)(TabsScroller, {
      ...
      ref: tabsRef,
      children: [(0, import_jsx_runtime110.jsx)(FlexContainer, {
        "aria-label": ariaLabel,
        "aria-labelledby": ariaLabelledBy,
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-YNGBUEXX.js.map
