...
function useMounted() {
  ...
  const isMounted = (0, import_react20.useRef)(() => mounted.current);
...
function useUpdateEffect(fn, deps) {
  const isFirst = (0, import_react27.useRef)(true);
...
function useWillUnmount(fn) {
  ...
  (0, import_react29.useEffect)(() => () => onUnmount.current(), []);
}
...
function useTimeout() {
  ...
  const handleRef = (0, import_react30.useRef)();
...
var Carousel = React32.forwardRef(({
...
function useUncontrolledProp2(propValue, defaultValue, handler) {
  ...
  return [isProp2 ? propValue : stateValue, (0, import_react32.useCallback)((...args) => {
...
function useForceUpdate() {
  const [, dispatch] = (0, import_react33.useReducer)((state) => !state, false);
  return dispatch;
}
...
function useSafeState(state) {
  const isMounted = useMounted();
  return [state[0], (0, import_react34.useCallback)((nextState) => {
    if (!isMounted())
      return;
...
var $b5e257d569688ac6$var$SSRContext = (0, import_react38.default).createContext($b5e257d569688ac6$var$defaultContext);
function $b5e257d569688ac6$var$LegacySSRProvider(props) {
  let cur = (0, import_react38.useContext)($b5e257d569688ac6$var$SSRContext);
  ...
  return (0, import_react38.default).createElement($b5e257d569688ac6$var$SSRContext.Provider, {
    value
  }, props.children);
}
var $b5e257d569688ac6$var$warnedAboutSSRProvider = false;
function $b5e257d569688ac6$export$9f8ac96af4b1b2ae(props) {
  if (typeof (0, import_react38.default)["useId"] === "function") {
    if (!$b5e257d569688ac6$var$warnedAboutSSRProvider) {
      console.warn("In React 18, SSRProvider is not necessary and is a noop. You can remove it from your app.");
      $b5e257d569688ac6$var$warnedAboutSSRProvider = true;
    }
    return (0, import_react38.default).createElement((0, import_react38.default).Fragment, null, props.children);
  }
  return (0, import_react38.default).createElement($b5e257d569688ac6$var$LegacySSRProvider, props);
}
var $b5e257d569688ac6$var$canUseDOM = Boolean(typeof window !== "undefined" && window.document && window.document.createElement);
var $b5e257d569688ac6$var$componentIds = /* @__PURE__ */ new WeakMap();
function $b5e257d569688ac6$var$useCounter(isDisabled = false) {
  let ctx = (0, import_react38.useContext)($b5e257d569688ac6$var$SSRContext);
...
function $b5e257d569688ac6$var$useModernSSRSafeId(defaultId) {
  let id = (0, import_react38.default).useId();
  let [didSSR] = (0, import_react38.useState)($b5e257d569688ac6$export$535bd6ca7f90a273());
  let prefix = didSSR || false ? "react-aria" : `react-aria${$b5e257d569688ac6$var$defaultContext.prefix}`;
  return defaultId || `${prefix}-${id}`;
}
var $b5e257d569688ac6$export$619500959fc48b26 = typeof (0, import_react38.default)["useId"] === "function" ? $b5e257d569688ac6$var$useModernSSRSafeId : $b5e257d569688ac6$var$useLegacySSRSafeId;
...
function $b5e257d569688ac6$export$535bd6ca7f90a273() {
  if (typeof (0, import_react38.default)["useSyncExternalStore"] === "function")
    return (0, import_react38.default)["useSyncExternalStore"]($b5e257d569688ac6$var$subscribe, $b5e257d569688ac6$var$getSnapshot, $b5e257d569688ac6$var$getServerSnapshot);
  let cur = (0, import_react38.useContext)($b5e257d569688ac6$var$SSRContext);
  return cur.isSSR;
}
...
function useMediaQuery(query, targetWindow = typeof window === "undefined" ? void 0 : window) {
  ...
  const [matches, setMatches] = (0, import_react67.useState)(() => mql ? mql.matches : false);
  useIsomorphicEffect_default(() => {
...
function createBreakpointHook(breakpointValues) {
  ...
  function useBreakpoint2(breakpointOrMap, direction, window2) {
    ...
    let query = (0, import_react68.useMemo)(() => Object.entries(breakpointMap).reduce((query2, [key, direction2]) => {
...
function OverlayTrigger({
  ...
  return (0, import_jsx_runtime98.jsxs)(import_jsx_runtime97.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react76.cloneElement)(children, triggerProps), (0, import_jsx_runtime96.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip,
  ...
  (_ref2, ref) => {
    ...
    return (0, import_jsx_runtime111.jsx)(TabContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime111.jsx)(SelectableContext_default.Provider, {
        value: null,
        children: (0, import_jsx_runtime111.jsx)(Transition, {
          in: isActive,
          onEnter,
          onEntering,
          onEntered,
...
var ToastFade = React113.forwardRef((props, ref) => (0, import_jsx_runtime120.jsx)(Fade_default, {
  ...props,
  ref,
...
var Toast = React116.forwardRef(({
  ...
  return (0, import_jsx_runtime123.jsx)(ToastContext_default.Provider, {
    value: toastContext,
    children: hasAnimation && Transition ? (0, import_jsx_runtime123.jsx)(Transition, {
      in: show,
      unmountOnExit: true,
      children: toast
    }) : toast
